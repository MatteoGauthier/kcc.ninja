  ...
  return (
    <>
      <motion.div variants={variants} className="block w-full h-full card">
        <div className="flex items-center justify-between px-3 py-0 sm:py-1 bg-black/60 rounded-t-xl">
          <div className="flex items-center space-x-3 text-xs">{getDappsTags(dapp)}</div>
          <div className="flex items-center space-x-4 text-white">
            <a className="inline-flex items-center h-12 space-x-1 text-sm sm:h-auto " href={"https://twitter.com/" + dapp.Twitter}>
              <TwitterIcon /> <span className="hidden md:inline">{dapp.Twitter}</span> <span className="inline md:hidden">Twitter</span>
            </a>
            <a className="inline-flex items-center h-12 space-x-1 text-sm sm:h-auto " href={dapp.ExplorerTokenContractAdress}>
              <IconLayer /> <span className="hidden md:inline">Token Explorer</span> <span className="inline md:hidden">Explorer</span>
            </a>
          </div>
        </div>
